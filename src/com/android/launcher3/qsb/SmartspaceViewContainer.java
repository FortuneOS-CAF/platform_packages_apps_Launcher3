...
import org.fortune.launcher.FortuneQuickstepLauncher;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        FortuneQuickstepLauncher launcher = (FortuneQuickstepLauncher) ActivityContext.lookupContext(context);
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        FortuneQuickstepLauncher launcher = (FortuneQuickstepLauncher) ActivityContext.lookupContext(getContext());
